...
class CartPage extends Page {
    get cartProducts() { return $$('//div[@class="row"]//a'); }
    get cartItems() { return $$('.list-group-item'); }
    get removeBtns() { return $$('button.remove'); }
    get cartIcon() { return $('//a[text()=" Cart"]'); }
    get btnCheckout() { return $('.btn-block.btn.btn-primary'); }
